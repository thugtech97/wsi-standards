<ul class="nav nav-aside">
    ...
    @if(auth()->user()->hasAnyPermissions(['dashboard']))
    ...
    @if(auth()->user()->hasAnyPermissions(['pages.index', 'pages.create']))
    ...
    @if(auth()->user()->hasAnyPermissions(['albums.index', 'albums.edit', 'albums.create']))
    ...
    @if(auth()->user()->hasAnyPermissions(['file-manager.index']))
    ...
    @if(auth()->user()->hasAnyPermissions(['menus.index', 'menus.create']))
    ...
    @if(auth()->user()->hasAnyPermissions(['news.index', 'news.index', 'news.create', 'news-categories.index', 'news-categories.create']))
    ...
    @if(auth()->user()->hasAnyPermissions(['account.edit', 'website-settings.edit', 'audit-logs.index']))
    ...
    @if(auth()->user()->hasAnyPermissions(['users.index', 'users.create']))
    ...
    @if(auth()->user()->hasAnyPermissions(['roles.index', 'access.index', 'permission.index']))
