...
<div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
    ...
    <div style="padding:30px 60px;">
        <div style="text-align: center;padding: 20px 0;">
            <img src="{{ asset('storage/logos/'.Setting::get_company_logo_storage_path()) }}" alt="company logo" width="175" />
        </div>
        ...
        <table style="width:100%; padding: 20px;background: #f0f0f0;font-size: 14px;">
            ...
            <tr>
                ...
                <td>{{ $clientInfo['inquiry_type'] }}</td>
            </tr>
            <tr>
                <td width="30%"><strong>Full Name</strong></td>
                <td>{{ $clientInfo['fname']." ".$clientInfo['lname'] }}</td>
            </tr>
            <tr>
